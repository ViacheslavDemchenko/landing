...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return licenses; });
...
function licenses() {
  if (document.querySelector('.licenses__slider')) {
    var swiper = new _libs_swiper_bundle_min_js__WEBPACK_IMPORTED_MODULE_0___default.a('.licenses__slider', {
      spaceBetween: 20,
      loopedSlides: 1,
      slidesPerView: 4,
      autoHeight: true,
